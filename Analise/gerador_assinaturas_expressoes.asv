...
na = 8; nb = 8; nk = 1; % Ordem ajustada para capturar oscilações

% --- 1. CONFIGURAÇÕES DA CLASSE ATUAL ---
pasta_dados = 'I:\LSI_v2\STW_010\';
nome_classe = 'Saudavel'; % Nome da assinatura\

% Pasta destino para assinaturas
pasta_destino = 'C:\Users\rafin\OneDrive\Área de Trabalho\Assinaturas';
...
for arq = 1:length(arquivos)
    ...
    % --- IDENTIFICA E FILTRA FASES ATIVAS ---
...
mu_assinatura = mean(historico_Theta, 1);
sigma_assinatura = std(historico_Theta, 0, 1);
